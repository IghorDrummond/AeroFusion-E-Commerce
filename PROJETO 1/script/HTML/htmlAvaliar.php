            ...
            <fieldset class="d-flex w-100 sticky-top">
                <div class="dropdown w-100">
                    ...
                    <div class="dropdown-menu w-100">
                        <div class="d-flex align-items-center flex-wrap produtos" data-toggle="">
                            <img src="img/inserir_img" class="img-fluid rounded border border-secondary p-1 m-2" width="100" height="100">
                            <h6>Produto</h6>
                        </div>
                    </div>
                </div>
