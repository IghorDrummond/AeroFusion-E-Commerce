	...
	?>
		<article id="Configuracao" class="mt-2 bg-warning rounded p-1">
			...
			<div class="bg-white rounded m-3 p-1">
				...
				<hr>
				<form class="form-group text-center" onsubmit="atualizarEndereco()" CL>
					<fieldset>
						...
						<div class="caixa_cartao">
							<div id="cartao">
								...
								<div class="cartaoLado d-flex flex-column">
									<img class="img-fluid ml-auto"
										src="https://cdn-icons-png.flaticon.com/512/2695/2695969.png" name="operadora"
										alt="Operadora Cartão" width="50">
									...
									<input id="numero_cartao" name="numero_cartao" type="text"
										placeholder="0000 0000 0000 0000" maxlength="19" maxlength="19" required
										onchange="bandeira(this)" onkeyup=" maskNumero(this)">
